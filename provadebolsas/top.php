...
<head>
    ...
    <title>FAM - Prova de Bolsas 2020</title>
    <link rel="stylesheet" href="assets/css/style.css"/>
    <link rel="stylesheet" href="assets/css/famcssx.css"/>
...
<body>
    ...
    <div class="js-loading" style="display: -ms-flexbox;display: flex;background:rgba(0, 74, 133, 1);position: fixed;top: 0;left: 0;right: 0;bottom: 0;z-index: 99999999;-ms-flex-align: center!important;align-items: center!important;-ms-flex-pack: center!important;justify-content: center!important;"><img src="assets/img/loading.svg"/></div>

    <header class="l-header headerx" style="">
        <div class="col-md-12 container margintop" style="">
            <nav class="c-nav d-flex flex-wrap justify-content-between align-items-center">
                <a href="/" class="c-nav__logo-link">
                    <img class="c-nav__logo" src="assets/img/logox.png" alt="FAM - Faculdade de Americana - 20 Anos">
                </a>
                <ul class="c-nav__menu">
                    <a href="assets/doc/Regulamento_prova de bolsas_2020.1 01.pdf" target="_blank" class="c-nav__link"><li class="c-nav__item">Edital</li></a>
                    <a href="assets/doc/Gabarito.pdf" target="_blank" class="c-nav__link"><li class="c-nav__item">Gabarito</li></a>
                    <a href="assets/doc/PROVA_BOLSAS_2020.pdf" target="_blank" class="c-nav__link"><li class="c-nav__item">Resultados</li></a>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main class="l-main container">
        <img src="assets/img/chamadax.png" class="l-header__chamada" alt="Bolsas de até 100% - Prova de Bolsas.com.br 2020 - Inscreva-se abaixo!">
        <img src="assets/img/frasex.png" class="l-header__chamad frasex">
 
 <div class="text-center" id="selectx" style="display: none;">
            <div>
                <select class="c-form__select input-cont-textarea listx" id="curso" required style="">
